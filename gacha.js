...
function addChar(x, y, z, n){
	...
	if(x==5){
		...
		if(z > 0){
			...
			newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="bempty1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div></div>';
		}else{
			par = document.getElementById("container"+x);
			newcontent = document.createElement('div');
			newcontent.innerHTML = '<div class="entry2hide"><div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="bempty1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div></div>';
		}
...
function addWeapon(x, y, z, n){
	...
	if(x==6){
		...
		if(z > 0){
			par = document.getElementById("container"+x);
			newcontent = document.createElement('div');
			newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="bempty1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div></div>';
		}else{
			par = document.getElementById("container"+x);
			newcontent = document.createElement('div');
			newcontent.innerHTML = '<div class="entry2hide"><div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="bempty1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div></div>';
		}
		par.appendChild(newcontent);
	}else if(x==8){
...
function addCharS(x, y, z, n){
	...
	var newcontent = document.createElement('div');
	if(z > 0){
	newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2"></div></div>';
    }else{
	newcontent.innerHTML = '<div class="entry2hide"><div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2"></div></div>';
	}
	parent.appendChild(newcontent);
}
function addWeaponS(x, y, z, n){
	...
	var newcontent = document.createElement('div');
	if(z > 0){
	newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2"></div></div>';
    }else{
	newcontent.innerHTML = '<div class="entry2hide"><div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2"></div></div>';
	}
	parent.appendChild(newcontent);
}
function editChar(x){
	...
	for (var k = 0; k< jason.length; k++) {
			...
			if(freeChars[k][3]==freeChars[k][2]){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[freeChars[k][1]][1]+'</div><div class="b1" id="b1" onclick="min('+freeChars[k][0]+','+freeChars[k][1]+','+freeChars[k][2]+','+freeChars[k][3]+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+freeChars[k][2]+'</div><div class="bempty2" id="b2"></div></div>';		
			}else if(freeChars[k][2]==0){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[freeChars[k][1]][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+freeChars[k][2]+'</div><div class="b2" id="b2" onclick="max('+freeChars[k][0]+','+freeChars[k][1]+','+freeChars[k][2]+','+freeChars[k][3]+')"></div></div>';		
			}else{
	...
	for (var k = 0; k< jason.length; k++) {
			...
			if(shopChars[k][3]==shopChars[k][2]){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[shopChars[k][1]][1]+'</div><div class="b1" id="b1" onclick="min('+shopChars[k][0]+','+shopChars[k][1]+','+shopChars[k][2]+','+shopChars[k][3]+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+shopChars[k][2]+'</div><div class="bempty2" id="b2"></div></div>';		
			}else if(shopChars[k][2]==0){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[shopChars[k][1]][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+shopChars[k][2]+'</div><div class="b2" id="b2" onclick="max('+shopChars[k][0]+','+shopChars[k][1]+','+shopChars[k][2]+','+shopChars[k][3]+')"></div></div>';		
			}else{
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+chars[shopChars[k][1]][1]+'</div><div class="b1" id="b1" onclick="min('+shopChars[k][0]+','+shopChars[k][1]+','+shopChars[k][2]+','+shopChars[k][3]+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+shopChars[k][2]+'</div><div class="b2" id="b2" onclick="max('+shopChars[k][0]+','+shopChars[k][1]+','+shopChars[k][2]+','+shopChars[k][3]+')"></div></div>';			
			}
		container.appendChild(newcontent);
       }	
	}
...
function editWeapons(x){
	...
	for (var k = 0; k< jason.length; k++) {
			...
			if(freeWeapons[k][3]==freeWeapons[k][2]){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+weapons[freeWeapons[k][1]][1]+'</div><div class="b1" id="b1" onclick="min('+freeWeapons[k][0]+','+id+','+freeWeapons[k][2]+','+freeWeapons[k][3]+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+freeWeapons[k][2]+'</div><div class="bempty2" id="b2"></div></div>';		
			}else if(freeWeapons[k][2]==0){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+weapons[freeWeapons[k][1]][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+freeWeapons[k][2]+'</div><div class="b2" id="b2" onclick="max('+freeWeapons[k][0]+','+id+','+freeWeapons[k][2]+','+freeWeapons[k][3]+')"></div></div>';		
			}else{
	...
	for (var k = 0; k< jason.length; k++) {
			...
			if(shopWeapons[k][3]==shopWeapons[k][2]){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+weapons[shopWeapons[k][1]][1]+'</div><div class="b1" id="b1" onclick="min('+shopWeapons[k][0]+','+id+','+shopWeapons[k][2]+','+shopWeapons[k][3]+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+shopWeapons[k][2]+'</div><div class="bempty2" id="b2"></div></div>';		
			}else if(shopWeapons[k][2]==0){
				newcontent.innerHTML = '<div class="entry2"><div class="name" style=" color: #ddd;">'+weapons[shopWeapons[k][1]][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+shopWeapons[k][2]+'</div><div class="b2" id="b2" onclick="max('+shopWeapons[k][0]+','+id+','+shopWeapons[k][2]+','+shopWeapons[k][3]+')"></div></div>';		
			}else{
			...
			for (var i = 0; i<arr.length; i++){
				...
				if (name[0] == chars[y][1]){
					x = x-10;
						if(z == n-1){
							z++;	
							arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="b1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2"></div>';			
						}else{
						z++;
						arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="b1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="b2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div>';			
						}				
					break;
				}
			}
			...
			for (var i = 0; i<arr.length; i++){
				...
				if (name[0] == weapons[y][1]){
					x = x-10;
						if(z == n-1){
							z++;	
							arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="b1" id="b1" onclick="min('+x+','+(y+1000)+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="bempty2" id="b2"></div>';			
						}else{
						z++;
						arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="b1" id="b1" onclick="min('+x+','+(y+1000)+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="b2" id="b2" onclick="max('+x+','+(y+1000)+','+z+','+n+')"></div>';			
						}				
					break;
				}
			}			
		...
		if (y<1000){				
			for (var i = 0; i<arr.length; i++){
				...
				if (name[0] == chars[y][1]){
					...
					if(z==1){
						z--;
						arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="b2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div>';			
					}else{
						z--;
						arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+chars[y][1]+'</div><div class="b1" id="b1" onclick="min('+x+','+y+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="b2" id="b2" onclick="max('+x+','+y+','+z+','+n+')"></div>';			
					}				
			...
			for (var i = 0; i<arr.length; i++){
				...
				if (name[0] == weapons[y][1]){
					...
					if(z==1){
						z--;
						arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="bempty1" id="b1"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="b2" id="b2" onclick="max('+x+','+(y+1000)+','+z+','+n+')"></div>';			
					}else{
						z--;
						arr[i].innerHTML = '<div class="name" style=" color: #ddd;">'+weapons[y][1]+'</div><div class="b1" id="b1" onclick="min('+x+','+(y+1000)+','+z+','+n+')"></div><div class="nr" id="nr" style=" color: #ddd;">'+z+'</div><div class="b2" id="b2" onclick="max('+x+','+(y+1000)+','+z+','+n+')"></div>';			
					}				
